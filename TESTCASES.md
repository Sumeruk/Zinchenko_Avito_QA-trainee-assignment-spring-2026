...
Название: Создание объявления позитивное c нулевыми полями статистики (likes, viewCount, contacts)
...
Ожидаемый результат:
- status Code 200
- на каждый запрос пришел валидный ответ формата:
```
{
  "id": "UUID-объявления",
  "sellerId": <Указанное значение из диапазона 111111-999999>,
  ...
  "price": <Значение из диапазона 1-9223372036854775807>,
  "statistics": {
    "likes": <Указанное значение>,
    "viewCount": <Указанное значение>,
    "contacts": <Указанное значение>
  },
  "createdAt": "yyyy-MM-dd HH:mm:ss.SSSSSS Z Z"
}
```
